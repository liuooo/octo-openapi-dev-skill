...
echo "═══ 1/5 check-swag-coverage.sh unit test ═══"
bash tests/fixtures/test-coverage-script.sh
echo

echo "═══ 2/5 check-prereqs.sh unit test ═══"
bash tests/fixtures/test-prereqs-script.sh
echo

echo "═══ 3/5 spectral function unit tests ═══"
...
echo "═══ 4/5 spectral rule fire-test (violations.yaml) ═══"
bash tests/fixtures/verify-rules-fire.sh
echo

echo "═══ 5/5 spectral clean-test (valid.yaml) ═══"
